...
topics: ["Python", "LINE Bot", "LINE", "Twitter", "API", "GCP"]
published: false
---
...
日替わりメニューを見るために Twitter をインストールしたくないという、とてもめんどくさいユーザーでした。
...
これだけならメジャーなサービスのどれでも実現できそうですが、個人的な好みで GCP の Cloud Functions を採用します。
